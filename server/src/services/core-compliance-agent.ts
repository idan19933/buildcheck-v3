...
## הוראות:
1. עבור כל דרישה, החזר סטטוס: PASS / FAIL / WARNING / CANNOT_CHECK.
2. CANNOT_CHECK כאשר אין מספיק נתונים ב-DXF — ציין בדיוק מה חסר ואיפה היית מצפה למצוא אותו.
3. ציין אילו נתונים שימשו לבדיקה.
4. חשב score = (PASS / (PASS + FAIL + WARNING)) * 100.
